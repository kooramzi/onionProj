...
public class buttonCalendar extends CalendarDataManager { // CalendarDataManager의 GUI + 메모기능 + 시계
	// 창 구성요소와 배치도
	JFrame mainFrame;
	JPanel calOpPanel;
	JButton todayBut;
	...
	public buttonCalendar() { // 구성요소 순으로 정렬되어 있음. 각 판넬 사이에 빈줄로 구별
	...
	private class ListenForCalOpButtons implements ActionListener {
		...
		class ThreadConrol extends Thread {
			public void run() {
